	...
	?>
		...
		<table width="100%" class="adminform">
			...
			<tr>
				...
				<td><?php echo JHTML::_('acyselect.radiolist', $picts, 'pict' , 'size="1" onclick="updateTag();"', 'value', 'text', $pageInfo->pict); ?></td>
				<td></td>
				<td></td>
			</tr>
		</table>
		...
		<table width="100%" class="adminform">
			...
			<tr>
				...
				<?php echo JText::_('AUTHOR_NAME'); ?>
				 ...
				 <td>
				 	<?php echo JHTML::_('acyselect.radiolist', $authorname, 'authorauto' , 'size="1" onclick="updateAutoTag();"', 'value', 'text', (string) $this->params->get('default_author','')); ?>
				</td>
			</tr>
			<tr>
				<td><?php echo JText::_('DISPLAY_PICTURES'); ?></td>
				<td><?php echo JHTML::_('acyselect.radiolist', $picts, 'pictauto' , 'size="1" onclick="updateAutoTag();"', 'value', 'text', $this->params->get('default_pict','1')); ?></td>
				<td><?php echo JText::_('FIELD_COLUMNS'); ?></td>
				<td><input type="text" name="cols" style="width:50px" value="1" onchange="updateAutoTag();"/></td>
			</tr>
			<tr>
				<td>
