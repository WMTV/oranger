...
<?php } ?>
		...
		<tr>
			...
			<td>
				...
				<input type="text" name="config[popup_width]" style="width:30px" value="<?php echo intval($this->config->get('popup_width',750)); ?>" /> x <input type="text" name="config[popup_height]"  style="width:30px" value="<?php echo intval($this->config->get('popup_height',550)); ?>" />
			</td>
		</tr>
		</table>
	</fieldset>
	<fieldset class="adminform">
		...
		<table class="admintable" cellspacing="1">
			...
			<tr>
				...
				<td>
					<?php echo JHTML::_('acyselect.booleanlist', "config[unsub_survey]" , '',$this->config->get('unsub_survey',1) ); ?>
				</td>
			</tr>
		</table>
	</fieldset>
