...
<div id="easyimage">
	<form class="form-validate" action="index.php" id="folderPopup" method="post" name="adminForm" autocomplete="off">
		...
		<div style="vertical-align:middle">
			<h4 style="display:inline;height:38px;margin:0px"><?php echo JText::_('EZIMG_RENAMEHDR'); ?></h4>
			<div style="float:right">
				<button class="btn btn-small btn-success" type="button" onclick="checkform('rename');"><i class="icon-apply icon-white"> </i> <?php echo JText::_('EZIMG_RENAME');?></button>
			...
			<fieldset>
				<div class="control-group">
					<div class="control-label">
						<span class="hasTip" 
						   title="<?php echo JText::_('EZIMG_RENAMELBL'); ?>::<?php echo JText::_('EZIMG_RENAMETIP'); ?>">
						   <?php echo JText::_('EZIMG_RENAMELBL'); ?>:
						</span>
					</div>
					<div class="control">
						<input class="required span12" type="text" name="newfolder" id="newfolder" value="<?php echo $this->folder; ?>" />
					</div>
				</div>
			</fieldset>
		</div>
