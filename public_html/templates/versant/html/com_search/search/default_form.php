...
<form id="searchForm" action="<?php echo JRoute::_('index.php?option=com_search');?>" method="post">
	...
	<fieldset class="word">
		...
		<input type="text" style="margin-bottom:0;" name="searchword" id="mod-search-searchword" size="30" maxlength="<?php echo $upper_limit; ?>" value="<?php echo $this->escape($this->origkeyword); ?>" class="input-medium" />
