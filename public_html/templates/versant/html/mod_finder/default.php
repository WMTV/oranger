...
$output = '<input type="text" name="q" id="mod-finder-searchword" style="margin-bottom:0;" class="inputbox" size="' . $params->get('field_size', 20) . '" value="' . htmlspecialchars(JFactory::getApplication()->input->get('q', '', 'string')) . '" />';
$button = '';
$label = '';
