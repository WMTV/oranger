<?php
	...
	$right2 = $this->countModules( 'right2' );
         $search_large = $this->countModules( 'search_large' );
	...
	if ($left2 || $user1_6 || $search_large || $right2) {

    echo '<div id="region2wrap" class="xtc-bodygutter">';

    echo '<div id="region2pad" class="xtc-wrapperpad">';

	echo '<div id="region2" class="row-fluid xtc-wrapper r2spacer r2nostrap">';
	...
	if ($user1_6) { echo '<div id="user1_6" class="span'.(12-$left2colgrid-$right2colgrid).'">'.$user1_6.'</div>'; }
       if ($search_large) { echo '<div id="search_large" class="span'.(12-$left2colgrid-$right2colgrid).'"><jdoc:include type="modules" name="search_large" style="xtc" /></div>'; }
