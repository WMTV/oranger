<?php
	...
	<div id="region3" class="fixedheight row-fluid xtc-wrapper r3spacer r3nostrap">
        <?php if ($left || $sidebarleft) { ?> <div id="left" class="fixedheightcol equalize span<?php echo $leftcolgrid;?>"><?php if($sidebarleft ){ ?><jdoc:include type="modules" name="sidebarleft" style="xtc" /><?php } ?><jdoc:include type="modules" name="left" style="xtc" /></div><?php }?>
	<div class="fixedheightcol equalize center span<?php echo (12-$leftcolgrid-$rightcolgrid);?> <?php echo $lc;?> <?php echo $rc;?>">
	...
	<?php if ( xtcCanShowComponent() ) { ?><div id="component" class="r3spacer_top"><jdoc:include type="component" /></div><?php }?>
        <?php if ($showcase1_6) {?><div id="showcase1_6" class="clearfix r3spacer_top"><?php echo $showcase1_6;?></div><?php }?>
	</div>
	 <?php if ($right || $sidebarright) { ?><div id="right" class="fixedheightcol equalize span<?php echo $rightcolgrid;?>"><?php if( $sidebarright ){ ?><jdoc:include type="modules" name="sidebarright" style="xtc" /><?php } ?><jdoc:include type="modules" name="right" style="xtc" /></div><?php }?>
	</div>
        </div>
	</div>
	<?php }
