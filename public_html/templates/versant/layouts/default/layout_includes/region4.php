   <?php
	...
	echo '<div id="region4" class="fixedheight row-fluid xtc-wrapper r4spacer">';
 
 
        if ($left4) { echo '<div id="left4" class="fixedheightcol span'.$left4colgrid.'"><jdoc:include type="modules" name="left4" style="xtc" /></div>';}
	echo '<div class="fixedheightcol center span'.(12-$left4colgrid-$right4colgrid).'">';
	...
	echo '</div>';
	if ($right4) { echo '<div id="right4" class="fixedheightcol span'.$right4colgrid.'"><jdoc:include type="modules" name="right4" style="xtc" /></div>';}
	echo '</div>';
        echo '</div>';
	echo '</div>';
	}
