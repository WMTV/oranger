<?php
	...
	echo '<div id="region5" class="fixedheight row-fluid xtc-wrapper r5spacer">';



        if ($left5) { echo '<div id="left5" class="fixedheightcol span'.$left5colgrid.'"><jdoc:include type="modules" name="left5" style="xtc" /></div>';}

	echo '<div class="fixedheightcol center span'.(12-$left5colgrid-$right5colgrid).'">';
	...
	if ($right5) { echo '<div id="right5" class="fixedheightcol span'.$right5colgrid.'"><jdoc:include type="modules" name="right5" style="xtc" /></div>';}
