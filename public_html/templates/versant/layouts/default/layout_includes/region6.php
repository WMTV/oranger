<?php
	...
	echo '<div id="region6" class="fixedheight row-fluid xtc-wrapper r6spacer">';



        if ($left6) { echo '<div id="left6" class="fixedheightcol span'.$left6colgrid.'"><jdoc:include type="modules" name="left6" style="xtc" /></div>';}

	echo '<div class="fixedheightcol center span'.(12-$left6colgrid-$right6colgrid).'">';
	...
	if ($right6) { echo '<div id="right6" class="fixedheightcol span'.$right6colgrid.'"><jdoc:include type="modules" name="right6" style="xtc" /></div>';}
