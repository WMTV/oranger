<?php
	...
	echo '<div id="region7" class="fixedheight row-fluid xtc-wrapper r7spacer">';



        if ($left7) { echo '<div id="left7" class="fixedheightcol span'.$left7colgrid.'"><jdoc:include type="modules" name="left7" style="xtc" /></div>';}

	echo '<div class="fixedheightcol center span'.(12-$left7colgrid-$right7colgrid).'">';
	...
	if ($right7) { echo '<div id="right7" class="fixedheightcol span'.$right7colgrid.'"><jdoc:include type="modules" name="right7" style="xtc" /></div>';}
