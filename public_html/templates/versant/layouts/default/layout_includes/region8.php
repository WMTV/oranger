<?php
	...
	echo '<div id="region8" class="fixedheight row-fluid xtc-wrapper r8spacer">';



        if ($left8) { echo '<div id="left8" class="fixedheightcol span'.$left8colgrid.'"><jdoc:include type="modules" name="left8" style="xtc" /></div>';}

	echo '<div class="fixedheightcol center span'.(12-$left8colgrid-$right8colgrid).'">';
	...
	if ($right8) { echo '<div id="right8" class="fixedheightcol span'.$right8colgrid.'"><jdoc:include type="modules" name="right8" style="xtc" /></div>';}
